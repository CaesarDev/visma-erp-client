 ...
 */
class ReopenSalesOrderActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReopenSalesOrderActionResultDto';
