 ...
 */
class CustomerSalesPriceQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerSalesPriceQueryParameters';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('effective_as_of', $data ?? [], null);
    ...
    */
     ...
     * Sets price_code
     *
     * @param string|null $price_code price_code
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $effective_as_of effective_as_of
     *
     * @return self
     */
    public function setEffectiveAsOf($effective_as_of)
    {
        if (is_null($effective_as_of)) {
            throw new \InvalidArgumentException('non-nullable effective_as_of cannot be null');
        }
