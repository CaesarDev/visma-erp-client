 ...
 */
class WebhookNotificationFeedbackDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookNotificationFeedbackDto';
    ...
    */
     ...
     *
     * @param string|null $notification_id The ID of the notification.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source The source of the notification
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description text of the notification. Such as \"Operation failed\".
     *
     * @return self
     */
     ...
     * Sets is_success
     *
     * @param bool|null $is_success Was the notification successfully consumed: True or false.
     *
     * @return self
     */
