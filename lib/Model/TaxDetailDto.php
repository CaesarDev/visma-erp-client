 ...
 */
class TaxDetailDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxDetailDto';
    ...
    protected static $openAPITypes = [
        'tax_id' => 'string',
        'record_id' => 'int',
        'vat_id' => '\OpenAPI\Client\Model\VatIdInTaxDetailDto',
        'vat_rate' => 'float',
    ...
    */
     ...
     * Sets tax_id
     *
     * @param string|null $tax_id Mandatory field: VAT ID* &gt; The ID of the VAT applied to the document.
     *
     * @return self
     */
     ...
     * Sets record_id
     *
     * @param int|null $record_id The id as stored in the database. It can be used when we want to update a VAT record.
     *
     * @return self
     */
     ...
     * Gets vat_id
     *
     * @return \OpenAPI\Client\Model\VatIdInTaxDetailDto|null
     */
     ...
     * Sets vat_id
     *
     * @param \OpenAPI\Client\Model\VatIdInTaxDetailDto|null $vat_id vat_id
     *
     * @return self
     */
     ...
     * Sets vat_rate
     *
     * @param float|null $vat_rate VAT rate &gt; The rate of the VAT.
     *
     * @return self
     */
     ...
     * Sets taxable_amount
     *
     * @param float|null $taxable_amount Taxable amount &gt; The taxable amount for the VAT, which is calculated at the document level.
     *
     * @return self
     */
     ...
     * Sets vat_amount
     *
     * @param float|null $vat_amount VAT &gt; The VAT amount for the specific VAT, which is calculated at the document level.
     *
     * @return self
     */
