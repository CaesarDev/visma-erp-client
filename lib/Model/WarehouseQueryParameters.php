...
/**
 * WarehouseQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WarehouseQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarehouseQueryParameters';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Selects only the warehouses that are active/inactive.
     *
     * @return self
     */
     ...
     * Sets branch
     *
     * @param string|null $branch Selects only the warehouses for the specified branch.
     *
     * @return self
     */
