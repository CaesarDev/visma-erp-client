 ...
 */
class ReleasePurchaseReceiptActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleasePurchaseReceiptActionResultDto';
