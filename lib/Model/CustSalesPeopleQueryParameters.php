 ...
 */
class CustSalesPeopleQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustSalesPeopleQueryParameters';
