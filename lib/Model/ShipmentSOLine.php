 ...
 */
class ShipmentSOLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentSOLine';
    ...
    */
     ...
     * Sets order_type
     *
     * @param string|null $order_type Sales Order Type
     *
     * @return self
     */
     ...
     * Sets order_number
     *
     * @param string|null $order_number Sales Order Number
     *
     * @return self
     */
     ...
     *
     * @param int|null $order_line_number Sales Order Line Number, optional if Inventory Id is entered
     *
     * @return self
     */
     ...
     * Sets inventory_id
     *
     * @param string|null $inventory_id Inventory Id, ignored if Order Line Number is specified. If more that one line on the Sales order has this Inventory Id, it will not work.
     *
     * @return self
     */
