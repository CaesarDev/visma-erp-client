...
/**
 * InventoryTransferDocumentQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventoryTransferDocumentQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventoryTransferDocumentQueryParameters';
    ...
    */
     ...
     * Sets warehouse
     *
     * @param string|null $warehouse Inventory transfer's source warehouse
     *
     * @return self
     */
     ...
     * Sets to_warehouse
     *
     * @param string|null $to_warehouse Inventory transfer's target warehouse
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date The date when the inventory document was created                Accepted format:  * ```yyyy-MM-dd```  * ```yyyy-MM-dd HH:mm:ss```  * ```yyyy-MM-dd HH:mm:ss.FFF```  * ```yyyy-MM-ddTHH:mm:ss```  * ```yyyy-MM-ddTHH:mm:ss.FFF```    _Note:_ __Date__ and __DateCondition__ are __mutually inclusive__.
     *
     * @return self
     */
