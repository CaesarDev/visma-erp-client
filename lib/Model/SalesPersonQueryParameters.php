 ...
 */
class SalesPersonQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesPersonQueryParameters';
    ...
    {
        $this->setIfExists('salesperson_cd', $data ?? [], null);
    ...
    */
     ...
     * Sets salesperson_cd
     *
     * @param string|null $salesperson_cd salesperson_cd
     *
     * @return self
     */
    public function setSalespersonCd($salesperson_cd)
    {
        if (is_null($salesperson_cd)) {
            throw new \InvalidArgumentException('non-nullable salesperson_cd cannot be null');
        }
     ...
     * Sets sales_sub
     *
     * @param string|null $sales_sub sales_sub
     *
     * @return self
     */
