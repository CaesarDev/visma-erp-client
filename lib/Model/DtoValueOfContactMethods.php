...
/**
 * DtoValueOfContactMethods Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DtoValueOfContactMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DtoValueOfContactMethods';
    ...
    public const VALUE_ANY = 'Any';
    public const VALUE_EMAIL = 'Email';
    public const VALUE_MAIL = 'Mail';
    public const VALUE_FAX = 'Fax';
    public const VALUE_PHONE = 'Phone';
