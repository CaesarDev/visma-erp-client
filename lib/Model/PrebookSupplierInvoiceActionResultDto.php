 ...
 */
class PrebookSupplierInvoiceActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrebookSupplierInvoiceActionResultDto';
