 ...
 */
class EmployeeQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeQueryParameters';
    ...
    {
        $this->setIfExists('linked_to_user', $data ?? [], null);
    ...
    */
     ...
     * Sets linked_to_user
     *
     * @param bool|null $linked_to_user If the employee is linked to a user.
     *
     * @return self
     */
    public function setLinkedToUser($linked_to_user)
    {
        if (is_null($linked_to_user)) {
            throw new \InvalidArgumentException('non-nullable linked_to_user cannot be null');
        }
