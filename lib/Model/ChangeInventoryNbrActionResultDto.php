 ...
 */
class ChangeInventoryNbrActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeInventoryNbrActionResultDto';
