 ...
 */
class PurchaseReceiptQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseReceiptQueryParameters';
    ...
    */
     ...
     * Sets receipt_date
     *
     * @param string|null $receipt_date receipt_date
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_custom_free_fields Parameter to include custom free fields information in the result set, if true then custom free fields will be included in the result set  Works only with PurchaseRecieptBasic and v2 of PurchaseReceipts.
     *
     * @return self
     */
