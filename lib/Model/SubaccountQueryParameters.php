 ...
 */
class SubaccountQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubaccountQueryParameters';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active If the SubAccount is active
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int|null $page_size Pagination parameter. Number of items to be collected
     *
     * @return self
     */
