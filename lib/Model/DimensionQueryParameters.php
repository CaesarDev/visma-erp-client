 ...
 */
class DimensionQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DimensionQueryParameters';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('expand_segments_values', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $expand_segments_values Flag can be used to return data without the segment values.
     *
     * @return self
     */
    public function setExpandSegmentsValues($expand_segments_values)
    {
        if (is_null($expand_segments_values)) {
            throw new \InvalidArgumentException('non-nullable expand_segments_values cannot be null');
        }
