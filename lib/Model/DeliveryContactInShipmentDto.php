...
/**
 * DeliveryContactInShipmentDto Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryContactInShipmentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deliveryContactInShipmentDto';
    ...
    */
     ...
     *
     * @param bool|null $override_contact Override contact &gt; A check box that you select to not use+ the default contact information and to type new contact information.
     *
     * @return self
     */
