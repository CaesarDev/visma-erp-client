...
/**
 * DirectDebitMandateDto Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectDebitMandateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectDebitMandateDto';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Mandate Guid as stored in the database.
     *
     * @return self
     */
     ...
     * Sets mandate_id
     *
     * @param string|null $mandate_id The id shown on Billing Address tab
     *
     * @return self
     */
     ...
     *
     * @param string|null $mandate_description Mandate description show on Billing Address tab
     *
     * @return self
     */
