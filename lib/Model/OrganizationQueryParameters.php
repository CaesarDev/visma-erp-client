 ...
 */
class OrganizationQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationQueryParameters';
    ...
    {
        $this->setIfExists('expand_branches', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $expand_branches True to expand all Branches related to this Organization.
     *
     * @return self
     */
    public function setExpandBranches($expand_branches)
    {
        if (is_null($expand_branches)) {
            throw new \InvalidArgumentException('non-nullable expand_branches cannot be null');
        }
     ...
     *
     * @param bool|null $expand_bank_settings True to expand payment settings for organization.
     *
     * @return self
     */
