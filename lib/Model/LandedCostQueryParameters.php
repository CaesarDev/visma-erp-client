...
/**
 * LandedCostQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LandedCostQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LandedCostQueryParameters';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Landed Cost Code
     *
     * @return self
     */
     ...
     *
     * @param string|null $greater_than_value Enter the from-value for Landed Cost Code
     *
     * @return self
     */
