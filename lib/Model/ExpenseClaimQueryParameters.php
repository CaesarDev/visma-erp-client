 ...
 */
class ExpenseClaimQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpenseClaimQueryParameters';
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the document
     *
     * @return self
     */
     ...
     * Sets customer
     *
     * @param string|null $customer The customer from the document
     *
     * @return self
     */
     ...
     * Sets department_id
     *
     * @param string|null $department_id Identifies the department
     *
     * @return self
     */
