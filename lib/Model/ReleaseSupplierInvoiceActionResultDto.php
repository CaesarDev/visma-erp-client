 ...
 */
class ReleaseSupplierInvoiceActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReleaseSupplierInvoiceActionResultDto';
