 ...
 */
class MetadataDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets max_page_size
     *
     * @param int|null $max_page_size max_page_size
     *
     * @return self
     */
    public function setMaxPageSize($max_page_size)
    {
        if (is_null($max_page_size)) {
            throw new \InvalidArgumentException('non-nullable max_page_size cannot be null');
        }
