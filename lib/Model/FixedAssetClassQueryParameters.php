...
/**
 * FixedAssetClassQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FixedAssetClassQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FixedAssetClassQueryParameters';
    ...
    */
     ...
     * Sets class_id
     *
     * @param string|null $class_id Fixed Asset Class ID that identifies the fixed asset class.
     *
     * @return self
     */
