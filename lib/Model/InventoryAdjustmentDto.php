...
class InventoryAdjustmentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'total_cost' => 'float',
        'control_cost' => 'float',
        'adjusment_lines' => '\OpenAPI\Client\Model\InventoryAdjustmentLineDto[]',
        ...
        'branch_number' => '\OpenAPI\Client\Model\BranchNumberInInventoryAdjustmentDto',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('adjusment_lines', $data ?? [], null);
    ...
    */
     ...
     * Sets control_cost
     *
     * @param float|null $control_cost The top part &gt; Control cost &gt; The manually entered cost of stock items listed in the adjustment. Control cost is available only if the Validate document totals on Entry option is selected on the Inventory preferences window. The user enters this value manually to confirm the total cost as calculated automatically for the document. If the Control Cost and Total Cost values do not match, the system generates a warning message and the document cannot be saved.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\InventoryAdjustmentLineDto[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InventoryAdjustmentLineDto[]|null $adjusment_lines Transaction details tab &gt; The inventory adjusment lines
     *
     * @return self
     */
    public function setAdjusmentLines($adjusment_lines)
    {
        if (is_null($adjusment_lines)) {
            throw new \InvalidArgumentException('non-nullable adjusment_lines cannot be null');
        }
     ...
     * Gets branch_number
     *
     * @return \OpenAPI\Client\Model\BranchNumberInInventoryAdjustmentDto|null
     */
     ...
     * Sets branch_number
     *
     * @param \OpenAPI\Client\Model\BranchNumberInInventoryAdjustmentDto|null $branch_number branch_number
     *
     * @return self
     */
