 ...
 */
class SalesOrderQueryParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderQueryParameters';
    ...
    */
     ...
     * Sets order_type
     *
     * @param string|null $order_type Filter by Order type.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Select to filter on status on order.
     *
     * @return self
     */
     ...
     *
     * @param string|null $greater_than_value Filter on Order no. greater than value.
     *
     * @return self
     */
     ...
     * Sets show_notes
     *
     * @param bool|null $show_notes Set to true to include notes.
     *
     * @return self
     */
