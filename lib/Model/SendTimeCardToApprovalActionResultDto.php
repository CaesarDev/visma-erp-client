 ...
 */
class SendTimeCardToApprovalActionResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendTimeCardToApprovalActionResultDto';
