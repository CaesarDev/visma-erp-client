# OpenAPI\Client\SalesOrderTypeApi
...
| [**salesOrderTypeGetSalesOrderTypeByorderType()**](SalesOrderTypeApi.md#salesOrderTypeGetSalesOrderTypeByorderType) | **GET** /v1/salesordertype/{orderType} | Get a specific SO OrderType |


## `salesOrderTypeGetAllSalesOrderTypes()`

```php
salesOrderTypeGetAllSalesOrderTypes($order_by, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\SalesOrderTypeDto[]
```
...
$apiInstance = new OpenAPI\Client\Api\SalesOrderTypeApi(
...
try {
    $result = $apiInstance->salesOrderTypeGetAllSalesOrderTypes($order_by, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\SalesOrderTypeDto[]**](../Model/SalesOrderTypeDto.md)
...
```php
salesOrderTypeGetSalesOrderTypeByorderType($order_type, $erp_api_background): \OpenAPI\Client\Model\SalesOrderTypeDto
```
...
try {
    $result = $apiInstance->salesOrderTypeGetSalesOrderTypeByorderType($order_type, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
