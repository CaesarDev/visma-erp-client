# OpenAPI\Client\SupplierLocationApi
...
| ------------- | ------------- | ------------- |
| [**supplierLocationCreate()**](SupplierLocationApi.md#supplierLocationCreate) | **POST** /v1/supplierlocation | Create a Location |
| [**supplierLocationGetLocationBybAccountIdlocationId()**](SupplierLocationApi.md#supplierLocationGetLocationBybAccountIdlocationId) | **GET** /v1/supplierlocation/{bAccountId}/{locationId} | Get a specific Location of a Baccount |
| [**supplierLocationGetLocations()**](SupplierLocationApi.md#supplierLocationGetLocations) | **GET** /v1/supplierlocation | Get a range of Locations - List screen&#x3D;AP3030P1, Entry screen&#x3D;AP303010  Request page size must be lower or equal to the allowed max page size which is returned as part of the metadata information.  If requested page size is greater than allowed max page size, request will be limited to max page size |
| [**supplierLocationGetLocationsForBaccountBybAccountId()**](SupplierLocationApi.md#supplierLocationGetLocationsForBaccountBybAccountId) | **GET** /v1/supplierlocation/{bAccountId} | Get a range of Locations for a BAccount  Request page size must be lower or equal to the allowed max page size which is returned as part of the metadata information.  If requested page size is greater than allowed max page size, request will be limited to max page size |
| [**supplierLocationUpdateBybAccountIdlocationId()**](SupplierLocationApi.md#supplierLocationUpdateBybAccountIdlocationId) | **PUT** /v1/supplierlocation/{bAccountId}/{locationId} | Update a specific Location |


## `supplierLocationCreate()`

```php
supplierLocationCreate($supplier_location_update_dto, $erp_api_background): object
```
...
$apiInstance = new OpenAPI\Client\Api\SupplierLocationApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$supplier_location_update_dto = new \OpenAPI\Client\Model\SupplierLocationUpdateDto(); // \OpenAPI\Client\Model\SupplierLocationUpdateDto | Defines the data for the Location to create
...
try {
    $result = $apiInstance->supplierLocationCreate($supplier_location_update_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierLocationApi->supplierLocationCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **supplier_location_update_dto** | [**\OpenAPI\Client\Model\SupplierLocationUpdateDto**](../Model/SupplierLocationUpdateDto.md)| Defines the data for the Location to create | |
...
## `supplierLocationGetLocationBybAccountIdlocationId()`

```php
supplierLocationGetLocationBybAccountIdlocationId($b_account_id, $location_id, $erp_api_background): \OpenAPI\Client\Model\SupplierLocationDto
```

Get a specific Location of a Baccount

Data for a single supplier location. <br></br>  The response headers include an ETag after a successful GET operation.
...
try {
    $result = $apiInstance->supplierLocationGetLocationBybAccountIdlocationId($b_account_id, $location_id, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierLocationApi->supplierLocationGetLocationBybAccountIdlocationId: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\SupplierLocationDto**](../Model/SupplierLocationDto.md)
...
## `supplierLocationGetLocations()`

```php
supplierLocationGetLocations($location_id, $gln, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\SupplierLocationDto[]
```
...
try {
    $result = $apiInstance->supplierLocationGetLocations($location_id, $gln, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierLocationApi->supplierLocationGetLocations: ', $e->getMessage(), PHP_EOL;
}
```
...
## `supplierLocationGetLocationsForBaccountBybAccountId()`

```php
supplierLocationGetLocationsForBaccountBybAccountId($b_account_id, $location_id, $gln, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\SupplierLocationDto[]
```
...
try {
    $result = $apiInstance->supplierLocationGetLocationsForBaccountBybAccountId($b_account_id, $location_id, $gln, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierLocationApi->supplierLocationGetLocationsForBaccountBybAccountId: ', $e->getMessage(), PHP_EOL;
}
```
...
## `supplierLocationUpdateBybAccountIdlocationId()`

```php
supplierLocationUpdateBybAccountIdlocationId($b_account_id, $location_id, $supplier_location_update_dto, $erp_api_background, $if_match): \OpenAPI\Client\Model\BackgroundApiAcceptedDto
```
...
$b_account_id = 'b_account_id_example'; // string | Identifies the BAccount
$location_id = 'location_id_example'; // string | Identifies the Location
$supplier_location_update_dto = new \OpenAPI\Client\Model\SupplierLocationUpdateDto(); // \OpenAPI\Client\Model\SupplierLocationUpdateDto | The data to update for the Location
$erp_api_background = 'erp_api_background_example'; // string | Accepts the request and queues it to be executed in the background by our least busy worker. Responds with 202 Accepted and a document containing a JobId reference and details state location. Supported values: * a URL: when the background operation is finished, a notification will be posted to the URL with a document containing a reference id, status code and a details state location. * \"none\" (without quotes): Fire and forget; no notification will be sent when background operation is finished. * \"subscription[:<name_1>=<value_1>,..,<name_n>=<value_n>]\" (without quotes): when the background operation is finsihed, a notification is posted to the Webhook subscription set up in Developer Portal for your integration client. Optionally a set of name-value pairs can be added. These will be sent as headers in the POST request to the Webhook subscription's url.  To find status and details of a background-api operation, GET .. v1/background/{id}. To get the response payload of a background-api operation, if any, GET .. v1/background/{id}/content
...
try {
    $result = $apiInstance->supplierLocationUpdateBybAccountIdlocationId($b_account_id, $location_id, $supplier_location_update_dto, $erp_api_background, $if_match);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierLocationApi->supplierLocationUpdateBybAccountIdlocationId: ', $e->getMessage(), PHP_EOL;
}
```
...
| **b_account_id** | **string**| Identifies the BAccount | |
| **location_id** | **string**| Identifies the Location | |
| **supplier_location_update_dto** | [**\OpenAPI\Client\Model\SupplierLocationUpdateDto**](../Model/SupplierLocationUpdateDto.md)| The data to update for the Location | |
| **erp_api_background** | **string**| Accepts the request and queues it to be executed in the background by our least busy worker. Responds with 202 Accepted and a document containing a JobId reference and details state location. Supported values: * a URL: when the background operation is finished, a notification will be posted to the URL with a document containing a reference id, status code and a details state location. * \&quot;none\&quot; (without quotes): Fire and forget; no notification will be sent when background operation is finished. * \&quot;subscription[:&lt;name_1&gt;&#x3D;&lt;value_1&gt;,..,&lt;name_n&gt;&#x3D;&lt;value_n&gt;]\&quot; (without quotes): when the background operation is finsihed, a notification is posted to the Webhook subscription set up in Developer Portal for your integration client. Optionally a set of name-value pairs can be added. These will be sent as headers in the POST request to the Webhook subscription&#39;s url.  To find status and details of a background-api operation, GET .. v1/background/{id}. To get the response payload of a background-api operation, if any, GET .. v1/background/{id}/content | [optional] |
