...
| ------------- | ------------- | ------------- |
| [**currencyGetAll()**](CurrencyApi.md#currencyGetAll) | **GET** /v1/currency | Get all available Currencies - ScreenId&#x3D;CM202000 |
| [**currencyGetSpecificCurrencyBycuryId()**](CurrencyApi.md#currencyGetSpecificCurrencyBycuryId) | **GET** /v1/currency/{curyId} | Get a specific Currency - ScreenId&#x3D;CM202000 |


## `currencyGetAll()`

```php
currencyGetAll($erp_api_background): \OpenAPI\Client\Model\CurrencyDto[]
```
...
try {
    $result = $apiInstance->currencyGetAll($erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CurrencyApi->currencyGetAll: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
currencyGetSpecificCurrencyBycuryId($cury_id, $erp_api_background): \OpenAPI\Client\Model\CurrencyDto
```
...
try {
    $result = $apiInstance->currencyGetSpecificCurrencyBycuryId($cury_id, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
