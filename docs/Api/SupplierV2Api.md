...
| ------------- | ------------- | ------------- |
| [**supplierV2GetAllSupplierBalance()**](SupplierV2Api.md#supplierV2GetAllSupplierBalance) | **GET** /v2/supplier/balance | Get the balance for one or multiple suppliers |


## `supplierV2GetAllSupplierBalance()`

```php
supplierV2GetAllSupplierBalance($from_fin_period, $to_fin_period, $branch, $supplier, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\SupplierBalanceV2Dto[]
```
...
$apiInstance = new OpenAPI\Client\Api\SupplierV2Api(
...
try {
    $result = $apiInstance->supplierV2GetAllSupplierBalance($from_fin_period, $to_fin_period, $branch, $supplier, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SupplierV2Api->supplierV2GetAllSupplierBalance: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\SupplierBalanceV2Dto[]**](../Model/SupplierBalanceV2Dto.md)
