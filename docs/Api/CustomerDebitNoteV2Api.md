# OpenAPI\Client\CustomerDebitNoteV2Api
...
| ------------- | ------------- | ------------- |
| [**customerDebitNoteV2Create()**](CustomerDebitNoteV2Api.md#customerDebitNoteV2Create) | **POST** /v2/customerDebitNote | Create a Customer Debit Note. ScreenID&#x3D;AR301000 |


## `customerDebitNoteV2Create()`

```php
customerDebitNoteV2Create($customer_debit_note_update_dto, $erp_api_background): object
```
...
$apiInstance = new OpenAPI\Client\Api\CustomerDebitNoteV2Api(
...
try {
    $result = $apiInstance->customerDebitNoteV2Create($customer_debit_note_update_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
