...
| ------------- | ------------- | ------------- |
| [**unitOfMeasureGetAllUnitsOfMeasure()**](UnitOfMeasureApi.md#unitOfMeasureGetAllUnitsOfMeasure) | **GET** /v1/unitofmeasure | Get a range of Units of Measure - ScreenId&#x3D;CS203100 |


## `unitOfMeasureGetAllUnitsOfMeasure()`

```php
unitOfMeasureGetAllUnitsOfMeasure($erp_api_background): \OpenAPI\Client\Model\UnitOfMeasureDto[]
```
...
try {
    $result = $apiInstance->unitOfMeasureGetAllUnitsOfMeasure($erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\UnitOfMeasureDto[]**](../Model/UnitOfMeasureDto.md)
