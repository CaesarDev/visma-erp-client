...
| ------------- | ------------- | ------------- |
| [**customerV2GetAllCustomerBalance()**](CustomerV2Api.md#customerV2GetAllCustomerBalance) | **GET** /v2/customer/balance | Get the balance for one or multiple customers |


## `customerV2GetAllCustomerBalance()`

```php
customerV2GetAllCustomerBalance($from_fin_period, $to_fin_period, $branch_number, $customer, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\CustomerBalanceV2Dto[]
```
...
$apiInstance = new OpenAPI\Client\Api\CustomerV2Api(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$from_fin_period = 'from_fin_period_example'; // string | Filter from financial period, format YYYYPP  The filte is inclusive, the records for the specified period will be included in the results.  This filter is required.
$to_fin_period = 'to_fin_period_example'; // string | Filter to financial period, format YYYYPP  The filte is inclusive, the records for the specified period will be included in the results.  This filter is required.
$branch_number = 'branch_number_example'; // string | Filter by Branch
...
try {
    $result = $apiInstance->customerV2GetAllCustomerBalance($from_fin_period, $to_fin_period, $branch_number, $customer, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CustomerV2Api->customerV2GetAllCustomerBalance: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\CustomerBalanceV2Dto[]**](../Model/CustomerBalanceV2Dto.md)
