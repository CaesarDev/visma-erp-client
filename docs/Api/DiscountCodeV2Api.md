# OpenAPI\Client\DiscountCodeV2Api
...
| ------------- | ------------- | ------------- |
| [**discountCodeV2GetDiscountCodes()**](DiscountCodeV2Api.md#discountCodeV2GetDiscountCodes) | **GET** /v2/discountCode | Get a range of discount codes - ScreenId&#x3D;AR209000 |


## `discountCodeV2GetDiscountCodes()`

```php
discountCodeV2GetDiscountCodes($last_modified_date_time, $last_modified_date_time_condition, $created_date_time, $created_date_time_condition, $discount_code, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\DiscountCodeDto[]
```
...
$apiInstance = new OpenAPI\Client\Api\DiscountCodeV2Api(
...
try {
    $result = $apiInstance->discountCodeV2GetDiscountCodes($last_modified_date_time, $last_modified_date_time_condition, $created_date_time, $created_date_time_condition, $discount_code, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DiscountCodeV2Api->discountCodeV2GetDiscountCodes: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\DiscountCodeDto[]**](../Model/DiscountCodeDto.md)
