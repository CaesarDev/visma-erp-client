# OpenAPI\Client\FixedAssetClassApi
...
| ------------- | ------------- | ------------- |
| [**fixedAssetClassGetAll()**](FixedAssetClassApi.md#fixedAssetClassGetAll) | **GET** /v1/fixedAssetClass | Get a range of Fixed Asset Classes - Screen ID:FA201000 |
| [**fixedAssetClassGetByClassID()**](FixedAssetClassApi.md#fixedAssetClassGetByClassID) | **GET** /v1/fixedAssetClass/{ClassID} | Get a specific Fixed Asset Class - Screen ID:FA201000 |


## `fixedAssetClassGetAll()`

```php
fixedAssetClassGetAll($class_id, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\FixedAssetClassDto[]
```

Get a range of Fixed Asset Classes - Screen ID:FA201000
...
$apiInstance = new OpenAPI\Client\Api\FixedAssetClassApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$class_id = 'class_id_example'; // string | Fixed Asset Class ID that identifies the fixed asset class.
...
try {
    $result = $apiInstance->fixedAssetClassGetAll($class_id, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FixedAssetClassApi->fixedAssetClassGetAll: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **class_id** | **string**| Fixed Asset Class ID that identifies the fixed asset class. | [optional] |
...
[**\OpenAPI\Client\Model\FixedAssetClassDto[]**](../Model/FixedAssetClassDto.md)
...
## `fixedAssetClassGetByClassID()`

```php
fixedAssetClassGetByClassID($class_id, $erp_api_background): \OpenAPI\Client\Model\FixedAssetClassDto
```
...
try {
    $result = $apiInstance->fixedAssetClassGetByClassID($class_id, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FixedAssetClassApi->fixedAssetClassGetByClassID: ', $e->getMessage(), PHP_EOL;
}
```
