...
| ------------- | ------------- | ------------- |
| [**customerPaymentCreatePayment()**](CustomerPaymentApi.md#customerPaymentCreatePayment) | **POST** /v1/customerPayment | Create a Payment |
| [**customerPaymentGetAllPayments()**](CustomerPaymentApi.md#customerPaymentGetAllPayments) | **GET** /v1/customerPayment | Get a range of Payments. - SceenId&#x3D;AR302000  Request page size must be lower or equal to the allowed max page size which is returned as part of the metadata information.  If requested page size is greater than allowed max page size, request will be limited to max page size |
| [**customerPaymentGetBypaymentNumber()**](CustomerPaymentApi.md#customerPaymentGetBypaymentNumber) | **GET** /v1/customerPayment/{paymentNumber} | Get a specific Payment |
| [**customerPaymentPutBypaymentNumber()**](CustomerPaymentApi.md#customerPaymentPutBypaymentNumber) | **PUT** /v1/customerPayment/{paymentNumber} | Update a specific Payment |
| [**customerPaymentReleasePaymentBypaymentNumber()**](CustomerPaymentApi.md#customerPaymentReleasePaymentBypaymentNumber) | **POST** /v1/customerPayment/{paymentNumber}/action/release | Release payment operation |
| [**customerPaymentVoidPaymentBypaymentNumber()**](CustomerPaymentApi.md#customerPaymentVoidPaymentBypaymentNumber) | **POST** /v1/customerPayment/{paymentNumber}/action/void | Void payment operation |


## `customerPaymentCreatePayment()`

```php
customerPaymentCreatePayment($payment_update_dto, $erp_api_background): object
```
...
try {
    $result = $apiInstance->customerPaymentCreatePayment($payment_update_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
```php
customerPaymentGetBypaymentNumber($payment_number, $erp_api_background): \OpenAPI\Client\Model\PaymentDto
```

Get a specific Payment

Data for Payment <br></br>  The response headers include an ETag after a successful GET operation.
...
try {
    $result = $apiInstance->customerPaymentGetBypaymentNumber($payment_number, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
```php
customerPaymentPutBypaymentNumber($payment_number, $payment_update_dto, $erp_api_background, $if_match): \OpenAPI\Client\Model\BackgroundApiAcceptedDto
```
...
try {
    $result = $apiInstance->customerPaymentPutBypaymentNumber($payment_number, $payment_update_dto, $erp_api_background, $if_match);
    print_r($result);
} catch (Exception $e) {
...
```php
customerPaymentReleasePaymentBypaymentNumber($payment_number, $release_payment_action_dto, $erp_api_background, $if_match): \OpenAPI\Client\Model\BackgroundApiAcceptedDto
```
...
try {
    $result = $apiInstance->customerPaymentReleasePaymentBypaymentNumber($payment_number, $release_payment_action_dto, $erp_api_background, $if_match);
    print_r($result);
} catch (Exception $e) {
...
```php
customerPaymentVoidPaymentBypaymentNumber($payment_number, $void_payment_action_dto, $erp_api_background, $if_match): \OpenAPI\Client\Model\BackgroundApiAcceptedDto
```
...
try {
    $result = $apiInstance->customerPaymentVoidPaymentBypaymentNumber($payment_number, $void_payment_action_dto, $erp_api_background, $if_match);
    print_r($result);
} catch (Exception $e) {
