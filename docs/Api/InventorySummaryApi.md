# OpenAPI\Client\InventorySummaryApi
...
| ------------- | ------------- | ------------- |
| [**inventorySummaryGetAllInventorySummaryByinventoryNumber()**](InventorySummaryApi.md#inventorySummaryGetAllInventorySummaryByinventoryNumber) | **GET** /v1/inventorysummary/{inventoryNumber} | Get a range of InventorySummary - ScreenId&#x3D;IN401000 |


## `inventorySummaryGetAllInventorySummaryByinventoryNumber()`

```php
inventorySummaryGetAllInventorySummaryByinventoryNumber($inventory_number, $warehouse, $location, $erp_api_background): \OpenAPI\Client\Model\InventorySummaryDto[]
```
...
$apiInstance = new OpenAPI\Client\Api\InventorySummaryApi(
...
try {
    $result = $apiInstance->inventorySummaryGetAllInventorySummaryByinventoryNumber($inventory_number, $warehouse, $location, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\InventorySummaryDto[]**](../Model/InventorySummaryDto.md)
