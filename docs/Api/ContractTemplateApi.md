# OpenAPI\Client\ContractTemplateApi
...
| ------------- | ------------- | ------------- |
| [**contractTemplateGetAll()**](ContractTemplateApi.md#contractTemplateGetAll) | **GET** /v1/contractTemplate | Get a range of Contract Templates - ScreenId&#x3D;CT202000 |


## `contractTemplateGetAll()`

```php
contractTemplateGetAll($greater_than_value, $number_to_read, $skip_records, $last_modified_date_time, $last_modified_date_time_condition, $expand_attributes, $erp_api_background): \OpenAPI\Client\Model\ContractTemplateDto[]
```
...
$apiInstance = new OpenAPI\Client\Api\ContractTemplateApi(
...
try {
    $result = $apiInstance->contractTemplateGetAll($greater_than_value, $number_to_read, $skip_records, $last_modified_date_time, $last_modified_date_time_condition, $expand_attributes, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\ContractTemplateDto[]**](../Model/ContractTemplateDto.md)
