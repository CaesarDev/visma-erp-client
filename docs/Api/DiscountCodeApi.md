# OpenAPI\Client\DiscountCodeApi
...
| ------------- | ------------- | ------------- |
| [**discountCodeGetDiscountCodes()**](DiscountCodeApi.md#discountCodeGetDiscountCodes) | **GET** /v1/discountCode | Get a range of discount codes - ScreenId&#x3D;AR209000 |


## `discountCodeGetDiscountCodes()`

```php
discountCodeGetDiscountCodes($last_modified_date_time, $last_modified_date_time_condition, $created_date_time, $created_date_time_condition, $discount_code, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\BasePaginationDtoOfDiscountCodeDto
```
...
$apiInstance = new OpenAPI\Client\Api\DiscountCodeApi(
...
try {
    $result = $apiInstance->discountCodeGetDiscountCodes($last_modified_date_time, $last_modified_date_time_condition, $created_date_time, $created_date_time_condition, $discount_code, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\BasePaginationDtoOfDiscountCodeDto**](../Model/BasePaginationDtoOfDiscountCodeDto.md)
