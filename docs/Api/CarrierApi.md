...
| ------------- | ------------- | ------------- |
| [**carrierGetAllCarriers()**](CarrierApi.md#carrierGetAllCarriers) | **GET** /v1/carrier | Get a range of Carriers - ScreeId&#x3D;CS207500 |
| [**carrierGetCarrierBycarrierName()**](CarrierApi.md#carrierGetCarrierBycarrierName) | **GET** /v1/carrier/{carrierName} | Get a specific Carrier |


## `carrierGetAllCarriers()`

```php
carrierGetAllCarriers($number_to_read, $skip_records, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\CarrierDto[]
```
...
$apiInstance = new OpenAPI\Client\Api\CarrierApi(
...
try {
    $result = $apiInstance->carrierGetAllCarriers($number_to_read, $skip_records, $last_modified_date_time, $last_modified_date_time_condition, $page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\CarrierDto[]**](../Model/CarrierDto.md)
...
```php
carrierGetCarrierBycarrierName($carrier_name, $erp_api_background): \OpenAPI\Client\Model\CarrierDto
```
...
try {
    $result = $apiInstance->carrierGetCarrierBycarrierName($carrier_name, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
