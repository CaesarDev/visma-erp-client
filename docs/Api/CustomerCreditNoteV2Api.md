# OpenAPI\Client\CustomerCreditNoteV2Api
...
| ------------- | ------------- | ------------- |
| [**customerCreditNoteV2Create()**](CustomerCreditNoteV2Api.md#customerCreditNoteV2Create) | **POST** /v2/customerCreditNote | Create a Customer Credit Note. ScreenID&#x3D;AR301000 |


## `customerCreditNoteV2Create()`

```php
customerCreditNoteV2Create($customer_credit_note_update_dto, $erp_api_background): object
```
...
$apiInstance = new OpenAPI\Client\Api\CustomerCreditNoteV2Api(
...
try {
    $result = $apiInstance->customerCreditNoteV2Create($customer_credit_note_update_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
