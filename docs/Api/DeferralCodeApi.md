# OpenAPI\Client\DeferralCodeApi
...
| ------------- | ------------- | ------------- |
| [**deferralCodeGetDeferralCodeBydeferralCodeId()**](DeferralCodeApi.md#deferralCodeGetDeferralCodeBydeferralCodeId) | **GET** /v1/deferralCode/{deferralCodeId} | Get a specific DeferralCode |
...
```php
deferralCodeGetDeferralCodeBydeferralCodeId($deferral_code_id, $erp_api_background): \OpenAPI\Client\Model\DeferralCodeDto
```
...
$apiInstance = new OpenAPI\Client\Api\DeferralCodeApi(
...
try {
    $result = $apiInstance->deferralCodeGetDeferralCodeBydeferralCodeId($deferral_code_id, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\DeferralCodeDto**](../Model/DeferralCodeDto.md)
...
```php
deferralCodeGetDeferralCodes($page_number, $page_size, $erp_api_background): \OpenAPI\Client\Model\DeferralCodeDto[]
```
...
try {
    $result = $apiInstance->deferralCodeGetDeferralCodes($page_number, $page_size, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
