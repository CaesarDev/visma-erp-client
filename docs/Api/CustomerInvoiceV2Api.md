# OpenAPI\Client\CustomerInvoiceV2Api
...
| ------------- | ------------- | ------------- |
| [**customerInvoiceV2Create()**](CustomerInvoiceV2Api.md#customerInvoiceV2Create) | **POST** /v2/customerinvoice | Create an Invoice. ScreenID&#x3D;AR301000 |


## `customerInvoiceV2Create()`

```php
customerInvoiceV2Create($customer_invoice_update_dto, $erp_api_background): object
```
...
$apiInstance = new OpenAPI\Client\Api\CustomerInvoiceV2Api(
...
try {
    $result = $apiInstance->customerInvoiceV2Create($customer_invoice_update_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
