# OpenAPI\Client\FirstTimeStartupApi
...
| ------------- | ------------- | ------------- |
| [**firstTimeStartupGet()**](FirstTimeStartupApi.md#firstTimeStartupGet) | **GET** /v1/firstTimeStartup/status | Get the status for FTS |


## `firstTimeStartupGet()`

```php
firstTimeStartupGet($erp_api_background): \OpenAPI\Client\Model\FirstTimeStartupDto
```
...
$apiInstance = new OpenAPI\Client\Api\FirstTimeStartupApi(
...
try {
    $result = $apiInstance->firstTimeStartupGet($erp_api_background);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FirstTimeStartupApi->firstTimeStartupGet: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\FirstTimeStartupDto**](../Model/FirstTimeStartupDto.md)
