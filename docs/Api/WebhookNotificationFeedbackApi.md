# OpenAPI\Client\WebhookNotificationFeedbackApi
...
| ------------- | ------------- | ------------- |
| [**webhookNotificationFeedbackPost()**](WebhookNotificationFeedbackApi.md#webhookNotificationFeedbackPost) | **POST** /v1/webhooknotificationfeedback | Creates/Inserts a WebhookNotificationFeedback |


## `webhookNotificationFeedbackPost()`

```php
webhookNotificationFeedbackPost($webhook_notification_feedback_dto, $erp_api_background): object
```
...
$apiInstance = new OpenAPI\Client\Api\WebhookNotificationFeedbackApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$webhook_notification_feedback_dto = new \OpenAPI\Client\Model\WebhookNotificationFeedbackDto(); // \OpenAPI\Client\Model\WebhookNotificationFeedbackDto | Define the data for the WebhookNotificationFeedback to create
...
try {
    $result = $apiInstance->webhookNotificationFeedbackPost($webhook_notification_feedback_dto, $erp_api_background);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **webhook_notification_feedback_dto** | [**\OpenAPI\Client\Model\WebhookNotificationFeedbackDto**](../Model/WebhookNotificationFeedbackDto.md)| Define the data for the WebhookNotificationFeedback to create | |
