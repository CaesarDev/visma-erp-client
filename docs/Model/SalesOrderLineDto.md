...
**requested_on** | **\DateTime** | Mandatory field: The top part  &amp;gt; Requested on* &amp;gt; The date when the customer wants to receive the goods. The default value is the current business date. | [optional]
**ship_on** | **\DateTime** | Ship on &amp;gt; The date when the item is to be shipped. | [optional]
...
**undership_threshold** | **float** | Undership threshold (%) &amp;gt; The minimal percentage of goods shipped (with respect to the ordered quantity) to consider the order shipped completely. | [optional]
**overship_threshold** | **float** | Overship threshold (%) &amp;gt; The maximum percentage of goods shipped (with respect to the ordered quantity) allowed by the customer. | [optional]
...
**expiration_date** | **\DateTime** | Expiration date &amp;gt; The expiration date for the item with the specified lot number. | [optional]
...
**sales_person** | [**\OpenAPI\Client\Model\SalesPersonInSalesOrderLineDto**](SalesPersonInSalesOrderLineDto.md) |  | [optional]
...
**subaccount** | [**\OpenAPI\Client\Model\SubaccountInSalesOrderLineDto**](SubaccountInSalesOrderLineDto.md) |  | [optional]
