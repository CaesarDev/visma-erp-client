...
**transaction_date** | **\DateTime** | Mandatory field: The top part &amp;gt; Transaction date* &amp;gt; The date when the batch was created, which relates to the transaction dates of the journal entries. | [optional]
...
**exchange_rate** | **float** | Ingformation collected from the system to calculate currency amount. | [optional]
...
**debit_total** | **float** | The top part &amp;gt; Debit total &amp;gt; The total of transaction debit amounts for the batch; the value is calculated automatically. | [optional]
**debit_total_in_currency** | **float** | Background calculation giving you the Debit total in your default currency. This field is applicable if the amount is given in another currency than your default. | [optional]
**credit_total** | **float** | The top part &amp;gt; Credit total &amp;gt; The total of transaction credit amounts for the batch; the value is calculated automatically. | [optional]
**credit_total_in_currency** | **float** | Background calculation giving you the Credit total in your default currency. This field is applicable if the amount is given in a another currency than your default. | [optional]
**control_total** | **float** | The top part &amp;gt; Control total &amp;gt; The control total of the batch, which is used for batch status validation. | [optional]
**control_total_in_currency** | **float** | Background calculation giving you the Control total in your default currency. This field is applicable if the amount is given in another currency than your default. | [optional]
...
**journal_transaction_lines** | [**\OpenAPI\Client\Model\JournalTransactionLineDto[]**](JournalTransactionLineDto.md) |  | [optional]
