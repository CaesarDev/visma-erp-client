...
**shipped_qty** | **float** | Orders tab &amp;gt; Shipped qty. &amp;gt; The quantity of goods shipped in accordance with the order. | [optional]
**shipped_weight** | **float** | Orders tab &amp;gt; Shipped weight &amp;gt; The weight of the goods shipped in accordance with the order. | [optional]
**shipped_volume** | **float** | Orders tab &amp;gt; Shipped volume &amp;gt; The volume of the goods shipped in accordance with the sales or transfer order. | [optional]
